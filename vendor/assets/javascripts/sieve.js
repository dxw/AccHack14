...
(function() {
  ...
  $.fn.sieve = function(options) {
    ...
    return this.each(function() {
      ...
      settings = $.extend({
        searchInput: null,
        searchTemplate: "<div class='form-search'><fieldset><input type='text' id='search' placeholder='Search for local authority'><span class='icon-search-1'></span></fieldset></div>",
